...
fun EditableTextPreference(
  ...
  Box(
    ...
    Layout(
      ...
      val inputField =
        (if (hasSummary) measurables[2] else measurables[1]).measure(rightConstraints)
      ...
      layout(constraints.maxWidth, totalHeight) {
        ...
        inputField.placeRelative(
          constraints.maxWidth - inputField.width,
          (totalHeight - inputField.height) / 2
        )
      }
    }
  }
