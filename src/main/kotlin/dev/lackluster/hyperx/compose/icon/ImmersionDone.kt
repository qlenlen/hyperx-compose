...
val MiuixIcons.ImmersionDone: ImageVector
  get() {
    if (_immersionDone != null) return _immersionDone!!
    _immersionDone = ImageVector.Builder("ImmersionDone", 26.0.dp, 26.0.dp, 26.0f, 26.0f).apply {
      path(
    ...
    return _immersionDone!!
  }

private var _immersionDone: ImageVector? = null